...
create or replace function public.sum_transactions_amount_v2(
...
-- Permissions
grant execute on function public.sum_transactions_amount_v2(date, date, public.transaction_type, uuid, text, text[], text[]) to authenticated;
